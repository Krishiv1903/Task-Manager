...
const TaskCard = ({
    ...
    const getStatusTagColor = () => {
        switch(status) {
            ...
            case "Completed":
                return "text-lime-600 bg-lime-50 border border-lime-600/10";

            default:
                return "text-red-600 bg-red-50 border border-red-600/10";
        }
    };
    ...
    const getPriorityTagColor = () => {
        switch(priority) {
            case "Low":
                return "text-emerald-600 bg-emerald-50 border border-emerald-600/10";

            case "Medium":
                return "text-amber-600 bg-amber-50 border border-amber-600/10";

            default:
                return "text-rose-600 bg-rose-50 border border-rose-600/10";
        }
    };
